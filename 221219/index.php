                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr class="fw-normal">
                                            ...
                                            <td class="align-middle">
                                                <span> <?= date("j M Y H:i", strtotime($todo["created_at"])) ?></span>
                                            </td>
                                            <td class="align-middle">
                                                <?php if ($todo["completed_at"] === NULL) { ?>
                                                    <a href="index.php?completed=<?= $todo["id"] ?>">
                                                        <button type="button" class="btn btn-warning">Mark as done</button> </a>

                                                <?php } else { ?>

                                                    <span> <?= "gedaan op " . date("j M Y H:i", strtotime($todo["created_at"])) ?> </span>
                                                <?php } ?>
